...
{
    public class MicroframeContext : Rock.Data.DbContext
    {
        #region Models
        public DbSet<Sign> Sign { get; set; }
        public DbSet<SignCategory> SignCategory { get; set; }
        #endregion

        /// <summary>
        /// Initializes a new instance of the <see cref="FamilyCheckinContext"/> class.
        /// </summary>
        public MicroframeContext()
            : base( "RockContext" )
        {
        ...
        protected override void OnModelCreating( DbModelBuilder modelBuilder )
        {
            ...
            Database.SetInitializer<MicroframeContext>( new NullDatabaseInitializer<MicroframeContext>() );
