...
<asp:UpdatePanel ID="upMain" runat="server">
    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlReturningGuest" runat="server" Visible="false" CssClass="container-fluid" DefaultButton="">
            ...
            <div class="row" style="padding-bottom: 15px;">
                <div class="col-sm-6 col-sm-offset-3">
                    <Rock:RockTextBox ID="tbReturningGuestNumber" runat="server" type="number" Required="true" CssClass="form-control input-lg"
