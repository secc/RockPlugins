...
{
    public class SafetyAndSecurityContext : Rock.Data.DbContext
    {
        #region Models
        ...
        /// </summary>
        public SafetyAndSecurityContext()
            : base( "RockContext" )
        {
        ...
        protected override void OnModelCreating( DbModelBuilder modelBuilder )
        {
            ...
            Database.SetInitializer<SafetyAndSecurityContext>( new NullDatabaseInitializer<SafetyAndSecurityContext>() );
