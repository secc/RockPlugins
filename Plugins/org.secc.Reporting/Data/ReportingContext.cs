...
{
    public class ReportingContext : Rock.Data.DbContext
    {
        #region Models

        public DbSet<DataViewSQLFilterStore> DataViewSQLFilterStores { get; set; }
        public DbSet<DecisionReportItem> DecisionReportItems { get; set; }
        ...
        protected override void OnModelCreating( DbModelBuilder modelBuilder )
        {
            ...
            Database.SetInitializer<ReportingContext>( new NullDatabaseInitializer<ReportingContext>() );
