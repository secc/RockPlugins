<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BelieveLeader.ascx.cs" Inherits="RockWeb.Blocks.Reporting.NextGen.BelieveLeader" %>
        ...
        <asp:Panel runat="server" ID="pnlMain" Visible="true">
            <div class="panel panel-block">
                <div class="panel-heading">
                    ...
                    <h1 class="panel-title"><i class="se se-msm"></i>Believe Leader Manager</h1>
                </div>
