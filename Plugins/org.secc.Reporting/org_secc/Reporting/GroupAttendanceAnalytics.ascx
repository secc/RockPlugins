<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupAttendanceAnalytics.ascx.cs" Inherits="RockWeb.Blocks.CheckIn.GroupAttendanceAnalytics" %>
        ...
        <div class="panel panel-block panel-analytics">
            <div class="panel-heading">
                <h1 class="panel-title">
                    ...
                    Small Group Attendance Analytics<asp:Literal ID="lSpecificGroupName" runat="server" />
                </h1>
                            ...
                            <Rock:RockControlWrapper ID="rcwGroupBy" runat="server" Label="Group By">
                                <div class="controls">
                                    <div class="js-group-by">
                                        ...
                                        <div class="btn-group">
                                            <asp:LinkButton ID="btnGroupByDay" runat="server" CssClass="btn btn-xs btn-default active" Text="Day" data-val="3" OnClick="btnGroupBy_Click" />
