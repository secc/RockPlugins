<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RegistrationDetail.ascx.cs" Inherits="RockWeb.Plugins.org_secc.Event.RegistrationDetail" %>
                    ...
                    <div id="pnlViewDetails" runat="server">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <Rock:RockControlWrapper runat="server" ID="rcwWorkflows" Visible="false" Label="Workflows">
                                    <asp:Repeater runat="server" ID="rWorkflow">
                                        <ItemTemplate>
                                            <asp:HiddenField runat="server" ID="hfWorkflow" Value='<%# Eval("Guid") %>' />
                                            <asp:LinkButton runat="server" Text='<%# Eval("Name") %>'
                                                ID="btnWorkflow" CssClass="btn btn-default btn-xs margin-b-sm"
                                                UseSubmitBehavior="False" OnClick="btnWorkflow_Click" />
                                        </ItemTemplate>
                                    </asp:Repeater>
