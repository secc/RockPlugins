...
{
    public class CommunicationDataContext : Rock.Data.DbContext
    {
        #region Models
        public DbSet<TwilioHistory> TwilioHistories { get; set; }
        #endregion

        /// <summary>
        /// Initializes a new instance of the <see cref="FamilyCheckinContext"/> class.
        /// </summary>
        public CommunicationDataContext()
            : base( "RockContext" )
        {
        ...
        protected override void OnModelCreating( DbModelBuilder modelBuilder )
        {
            ...
            Database.SetInitializer<CommunicationDataContext>( new NullDatabaseInitializer<CommunicationDataContext>() );
