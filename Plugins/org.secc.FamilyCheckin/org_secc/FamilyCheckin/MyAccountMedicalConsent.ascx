<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MyAccountMedicalConsent.ascx.cs" Inherits="Plugins_org_secc_FamilyCheckin_MyAccountMedicalConsent" %>

<asp:UpdatePanel ID="upnlContent" runat="server">
    <ContentTemplate>
        <Rock:NotificationBox ID="nbNoMinors" runat="server" Text="There are no minors in your family." Visible="false" CssClass="warning"/>
        <Rock:NotificationBox ID="nbAllMinorsHaveConsent" runat="server" Text="All minors in your family already have medical consent." Visible="false" CssClass="success" />
        ...
        <asp:Panel ID="pnlConsent" runat="server" Visible="false" CssClass="alert alert-danger">
            <div class="">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <p>
                                    ...
                                    <span ID="sCurrentPersonAddress" runat="server"></span><br />
                ...
                <div class="g-margin-t-10--xs row">
                    ...
                    <div class="col-sm-2">
                        <Rock:BootstrapButton runat="server" ID="btnConsent" Text="I consent" CssClass="btn btn-primary" OnClick="btnConsent_Click" />
                    </div>
