    ...
    <ContentTemplate>
        ...
        <asp:Panel runat="server" ID="pnlCampus" Visible="false">
            ...
            <div class="panel panel-block">
                ...
                <div class="panel-footer clearfix">
                    <Rock:BootstrapButton runat="server" ID="btnCampusNext" Text="Next" CssClass="btn btn-info  pull-right" OnClick="btnCampusNext_Click" />
                </div>
            </div>
        </asp:Panel>
        ...
        <asp:Panel runat="server" ID="pnlReview" Visible="false">
            <div class="panel panel-block">
                ...
                <div class="panel-footer clearfix">
                    <Rock:BootstrapButton runat="server" ID="btnReviewFinish" Text="Finish" CssClass="btn btn-info  pull-right" OnClick="btnReviewFinish_Click" />
                </div>
            </div>
        </asp:Panel>
