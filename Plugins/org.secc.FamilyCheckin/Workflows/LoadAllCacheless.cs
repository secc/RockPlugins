...
namespace org.secc.FamilyCheckin
{
    ...
    [Description( "Loads all information without using cache" )]
    [Export( typeof( ActionComponent ) )]
    [ExportMetadata( "ComponentName", "Load All Cacheless" )]
    public class LoadAllCacheless : CheckInActionComponent
    {
        /// <summary>
