...
namespace org.secc.FamilyCheckin.Controls
{
    /// <summary>
    /// Report Filter control
    /// </summary>
    [ToolboxData( "<{0}:CheckinGroupRowWithArchiving runat=server></{0}:CheckinGroupRowWithArchiving>" )]
    public class CheckinGroupRowWithArchiving : CompositeControl
    {
        ...
        private LinkButton _lblArchiveGroup;
...
$('.checkin-group a.btn-warning').click(function (event) {
    event.stopImmediatePropagation();
    if ( isDirty() ) {{
        return false;
    }}
...
var confirmArchive = function( e, nameText, additionalMsg ) {{
 /*               // make sure the element that triggered this event isn't disabled
                ...
                e.preventDefault();
                var msg = 'Are you sure you want to archive this ' + nameText + '?';
                if ( additionalMsg )
                {{
                    msg += ' ' + additionalMsg;
                }}
...
;
            ...
            ScriptManager.RegisterStartupScript( this.Page, this.Page.GetType(), "CheckinGroupRowWithArchiving", script, true );
        }
        ...
        protected override void CreateChildControls()
        {
            ...
            _lblArchiveGroup.Controls.Add( new LiteralControl { Text = "<i class='fa fa-archive'></i>" } );
        ...
        public override void RenderControl( HtmlTextWriter writer )
        {
            ...
            var groupRows = this.Controls.OfType<CheckinGroupRowWithArchiving>();
            if ( groupRows.Any() )
            {
        ...
        protected void lblArchiveGroup_Click( object sender, EventArgs e )
        {
            if ( ArchiveGroupClick != null )
            {
                ArchiveGroupClick( this, e );
            }
        }
        ...
        public event EventHandler ArchiveGroupClick;
