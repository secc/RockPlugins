...
namespace Rock.Workflow.Action
{
    ...
    [ExportMetadata( "ComponentName", "Update Discount Code With Attribute" )]

    [WorkflowTextOrAttribute( "Registration Template Name", "Registration Template Attribute", "Registration template the discount code belongs to.", required: true, order: 0, key: "RegistrationTemplate" )]
    ...
    public class UpdateDiscountCodeWithAttribute : ActionComponent
    {
        /// <summary>
        ...
        public override bool Execute( RockContext rockContext, WorkflowAction action, Object entity, out List<string> errorMessages )
        {
            ...
            {
                errorMessages.Add( "Could not find registration template ID." );
                return false;
            }
