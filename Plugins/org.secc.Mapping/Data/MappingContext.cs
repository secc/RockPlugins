...
{
    public class MappingContext : Rock.Data.DbContext
    {
        #region Models

        public DbSet<LocationDistanceStore> LocationDistanceStores { get; set; }
        ...
        protected override void OnModelCreating( DbModelBuilder modelBuilder )
        {
            ...
            Database.SetInitializer<MappingContext>( new NullDatabaseInitializer<MappingContext>() );
