...
<asp:UpdatePanel ID="upMain" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <div class="btn-group" role="group" style="margin-bottom: 10px;">
            ...
            <asp:LinkButton ID="lbMenuItem_AddMinistryApproval" CssClass="btn btn-default" runat="server" CommandName="addministryapproval" OnClick="lbMenuItem_Click" Visible="false">Add Ministry Approver</asp:LinkButton>
