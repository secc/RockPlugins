...
<Rock:NotificationBox runat="server" NotificationBoxType="Info" Text="Any changes made on this page will not take effect until Rock is restarted." />
<asp:UpdatePanel ID="pnlConfiguration" runat="server" Class="panel panel-block">
    <ContentTemplate>
        <div class="panel-heading">
            <h1 class="panel-title"><i class="fa fa-cloud"></i>OAuth Server Configuration</h1>
        </div>
            ...
            <Rock:ModalDialog ID="gOAuthClientEdit" runat="server" OnSaveClick="gOAuthClientEdit_SaveClick" Title="OAuth Client">
                <Content>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <Rock:RockCheckBoxList ID="cblClientScopes" runat="server" Label="Allowed Scopes - Selecting a scope overrides Rock security" DataValueField="Id" DataTextField="Value" />
                        </div>
                    </div>
                </Content>
            </Rock:ModalDialog>
