...
{
    [MigrationNumber(30, "1.12.7")]
    public class Finance_MoveContributionSummaryStoredProcedure : Migration
    {
			...
			Sql(@"
				...
				END
					...
					WHERE AccountId in (SELECT AccountId FROM #tmpAccounts)
						...
						AND t.TransactionDateTime >= '2025-04-01'
					...
					WHERE t.TransactionDateTime > '2025-04-01'
						AND t.TransactionDateTime < DATEADD(DAY, 1, @EndDate)
