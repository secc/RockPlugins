...
namespace org.secc.Migrations
{
    ...
    class FamilyCheckin_PageData : Migration
    {
        public override void Up()
        {
            ...
            RockMigrationHelper.UpdateBlockType( "Administration", "Check-in Administration block", "~/Blocks/CheckIn/Admin.ascx", "Check-in", "3B5FBE9A-2904-4220-92F3-47DD16E805C0" ); //Block Type: Administration
            ...
            RockMigrationHelper.AddBlockTypeAttribute( "AF961217-4223-4F03-9658-11DAB4B24DCD", "9C204CD0-1233-41C5-818A-C5DA439445AA", "Preselect Activity", "PreselectActivity", "", "Activity for preselecting classes.", 0, @"", "9BD6125E-8DBA-4EB2-8FFE-F449F9DF28AF" );
            ...
            RockMigrationHelper.AddBlockTypeAttribute( "3B5FBE9A-2904-4220-92F3-47DD16E805C0", "9C204CD0-1233-41C5-818A-C5DA439445AA", "Workflow Activity", "WorkflowActivity", "", "The name of the workflow activity to run on selection.", 1, @"", "50DF7B49-FAF4-45D5-919F-14E589B37666" );
            RockMigrationHelper.AddBlockTypeAttribute( "3B5FBE9A-2904-4220-92F3-47DD16E805C0", "BD53F9C9-EBA9-4D3F-82EA-DE5DD34A8108", "Home Page", "HomePage", "", "", 2, @"", "D46F3099-5700-4CCD-8B6C-F1F306BA02B8" );
            ...
            RockMigrationHelper.AddBlockTypeAttribute( "3B5FBE9A-2904-4220-92F3-47DD16E805C0", "BD53F9C9-EBA9-4D3F-82EA-DE5DD34A8108", "Previous Page", "PreviousPage", "", "", 3, @"", "7675AE35-1A61-460E-8FF6-B2A5C473F319" );
            RockMigrationHelper.AddBlockTypeAttribute( "3B5FBE9A-2904-4220-92F3-47DD16E805C0", "BD53F9C9-EBA9-4D3F-82EA-DE5DD34A8108", "Next Page", "NextPage", "", "", 4, @"", "36C334EF-E723-4065-9C39-BD5663582751" );
            ...
            RockMigrationHelper.AddBlockTypeAttribute( "3B5FBE9A-2904-4220-92F3-47DD16E805C0", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "Allow Manual Setup", "AllowManualSetup", "", "If enabled, the block will allow the kiosk to be setup manually if it was not set via other means.", 5, @"True", "EBBC10ED-18E4-4E7D-9467-E7C27F12A745" );
