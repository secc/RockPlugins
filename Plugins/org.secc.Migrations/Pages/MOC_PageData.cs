...
namespace org.secc.Migrations
{
    ...
    class MOC_PageData : Migration
    {
        public override void Up()
        {
            ...
            RockMigrationHelper.UpdateBlockType( "Dynamic Data", "Block to display dynamic report, html, xml, or transformed xml based on a SQL query or stored procedure.", "~/Blocks/Reporting/DynamicData.ascx", "Reporting", "E31E02E9-73F6-4B3E-98BA-E0E4F86CA126" ); //Block Type: Dynamic Data
            RockMigrationHelper.UpdateBlockType( "Workflow Entry", "Used to enter information for a workflow form entry action.", "~/Blocks/WorkFlow/WorkflowEntry.ascx", "WorkFlow", "A8BD05C8-6F89-4628-845B-059E686F089A" ); //Block Type: Workflow Entry
            RockMigrationHelper.UpdateBlockType( "Content Channel View", "Block to display dynamic content channel items.", "~/Blocks/Cms/ContentChannelView.ascx", "CMS", "143A2345-3E26-4ED0-A2FE-42AAF11B4C0F" ); //Block Type: Content Channel View
