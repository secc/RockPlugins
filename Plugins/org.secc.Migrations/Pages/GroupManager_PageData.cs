...
namespace org.secc.Migrations
{
    ...
    class GroupManager_PageData : Migration
    {
        public override void Up()
        {
            ...
            RockMigrationHelper.UpdateBlockType( "Page Menu", "Renders a page menu based on a root page and liquid template.", "~/Blocks/Cms/PageMenu.ascx", "CMS", "CACB9D1A-A820-4587-986A-D66A69EE9948" ); //Block Type: Page Menu
            RockMigrationHelper.UpdateBlockType( "Group Detail Lava", "Presents the details of a group using Lava", "~/Blocks/Groups/GroupDetailLava.ascx", "Groups", "218B057F-B214-4317-8E84-7A95CF88067E" ); //Block Type: Group Detail Lava
            RockMigrationHelper.UpdateBlockType( "Group List Personalized Lava", "Lists all group that the person is a member of using a Lava template.", "~/Blocks/Groups/GroupListPersonalizedLava.ascx", "Groups", "1B172C33-8672-4C98-A995-8E123FF316BD" ); //Block Type: Group List Personalized Lava
            RockMigrationHelper.UpdateBlockType( "Group Roster", "Presents roster of group in roster format only if current user is leader of group.", "~/Plugins/org_secc/GroupManager/GroupRoster.ascx", "", "18555BDC-87C1-4AD2-B22F-64936289A0D7" ); //Block Type: Group Roster
