...
namespace org.secc.Migrations
{
    ...
    class GroupManager_PageData : Migration
    {
        public override void Up()
        {
            ...
            RockMigrationHelper.UpdateBlockType( "Group Manager Attendance", "Lists the group members for a specific occurrence datetime and allows selecting if they attended or not.", "~/Plugins/org_secc/GroupManager/GroupManagerAttendance.ascx", "Groups", "AF0E5AE5-593C-4B18-B559-88BEF743D3E7" );
            RockMigrationHelper.UpdateBlockType( "Small Group Content", "Block to display dynamic small group content for a group.", "~/Plugins/org_secc/GroupManager/SmallGroupContent.ascx", "Groups", "51C366D6-EBD8-4202-BA5A-B845A7903ADC" );
            RockMigrationHelper.UpdateBlockType( "Group Registration Modal", "Allows a person to register for a group.", "~/Plugins/org_secc/GroupManager/GroupRegistrationModal.ascx", "Groups", "2AD8831E-8926-43A4-8CA1-095A60E0B2A2" );
            RockMigrationHelper.AddBlock( "20A6336A-C9F8-4F55-94BF-991B0D3B49D7", "", "1B172C33-8672-4C98-A995-8E123FF316BD", "Small Group Ministries", "Main", "", "", 0, "3FBE1AA2-247F-497F-AD5C-237C4EEFBFBC" );

            RockMigrationHelper.AddBlock( "20A6336A-C9F8-4F55-94BF-991B0D3B49D7", "", "1B172C33-8672-4C98-A995-8E123FF316BD", "Huddle Groups", "Main", "", "", 1, "4696B0F8-A461-44D2-AFEA-6DB317E13C61" );

            RockMigrationHelper.AddBlock( "20A6336A-C9F8-4F55-94BF-991B0D3B49D7", "", "1B172C33-8672-4C98-A995-8E123FF316BD", "Small Groups", "Main", "", "", 2, "A4212ABD-27BA-4028-B341-FBFCB98C6A4C" );

            RockMigrationHelper.AddBlock( "37053063-76C5-44EB-BC0A-043F10744CEC", "", "CACB9D1A-A820-4587-986A-D66A69EE9948", "Page Menu", "Main", "", "", 1, "E2EC1261-E0C7-4409-9D2E-531279AEC435" );

            RockMigrationHelper.AddBlock( "37053063-76C5-44EB-BC0A-043F10744CEC", "", "218B057F-B214-4317-8E84-7A95CF88067E", "Group Detail Lava", "Main", "", "", 0, "4B89477A-5401-47F3-A56A-8ED535C65253" );

            RockMigrationHelper.AddBlock( "3BAD929C-832C-4FF0-97C8-FB5E8698D9D8", "", "51C366D6-EBD8-4202-BA5A-B845A7903ADC", "Small Group Content", "Main", "", "", 1, "D45B7887-C728-4658-9865-095398CB8C84" );

            RockMigrationHelper.AddBlock( "3BAD929C-832C-4FF0-97C8-FB5E8698D9D8", "", "CACB9D1A-A820-4587-986A-D66A69EE9948", "Page Menu", "Navigation", "", "", 1, "7A183520-7216-4CB5-A7B8-0AD80E349A62" );

            RockMigrationHelper.AddBlock( "3BAD929C-832C-4FF0-97C8-FB5E8698D9D8", "", "CACB9D1A-A820-4587-986A-D66A69EE9948", "Page Menu", "Header", "", "", 0, "1970E8C3-0415-4253-984E-F2EFE7C9D4FF" );

            RockMigrationHelper.AddBlock( "8A5BB80C-BC42-4038-8F91-A9E875D8DC47", "", "18555BDC-87C1-4AD2-B22F-64936289A0D7", "Group Roster", "Main", "", "", 0, "C70E6839-D338-4B10-8C5A-EB43E65E4BA3" );

            RockMigrationHelper.AddBlock( "8A5BB80C-BC42-4038-8F91-A9E875D8DC47", "", "CACB9D1A-A820-4587-986A-D66A69EE9948", "Page Menu", "Navigation", "", "", 1, "7E56CA79-433A-459A-9E7E-0EEE9433BD34" );

            RockMigrationHelper.AddBlock( "8A5BB80C-BC42-4038-8F91-A9E875D8DC47", "", "2AD8831E-8926-43A4-8CA1-095A60E0B2A2", "Group Registration Modal", "Header", "<div style=\"margin-top:5px\">", "</div>", 0, "81D1AFD6-0448-40D5-8949-DE6A5A93D6F2" );

            RockMigrationHelper.AddBlock( "DC25DA8D-4247-4CC4-AC40-178195E9308E", "", "AF0E5AE5-593C-4B18-B559-88BEF743D3E7", "Group Manager Attendance", "Main", "", "", 0, "2731B0B8-376F-4350-9F83-E9487B92B693" );

            RockMigrationHelper.AddBlock( "DC25DA8D-4247-4CC4-AC40-178195E9308E", "", "CACB9D1A-A820-4587-986A-D66A69EE9948", "Page Menu", "Navigation", "", "", 0, "196CAEBC-DB97-4903-92BB-5FFEE466F8E7" );

            RockMigrationHelper.AddBlock( "DC25DA8D-4247-4CC4-AC40-178195E9308E", "", "2AD8831E-8926-43A4-8CA1-095A60E0B2A2", "Group Registration Modal", "Header", "", "", 0, "420DA9C4-27A4-46F0-951C-2935231E5E12" );

            RockMigrationHelper.AddBlock( "C0881189-7F82-4669-B4D9-8FCFD5E5DCE1", "", "51C366D6-EBD8-4202-BA5A-B845A7903ADC", "Small Group Content", "Main", "", "", 0, "663764A7-5D96-4C66-9907-63DC94D88787" );

            RockMigrationHelper.AddBlock( "C0881189-7F82-4669-B4D9-8FCFD5E5DCE1", "", "CACB9D1A-A820-4587-986A-D66A69EE9948", "Page Menu", "Navigation", "", "", 0, "D69774E9-1867-4E34-B53E-5C8DD558BF4F" );

            RockMigrationHelper.AddBlock( "00F0E543-F524-4A31-B040-B8613F91F854", "", "CACB9D1A-A820-4587-986A-D66A69EE9948", "Page Menu", "Navigation", "", "", 0, "813C6600-1B46-4FDB-965F-CDDA77E17949" );
            ...
            RockMigrationHelper.AddBlockTypeAttribute( "CACB9D1A-A820-4587-986A-D66A69EE9948", "1D0D3794-C210-48A8-8C68-3FBEC08A6BA5", "Template", "Template", "", "The liquid template to use for rendering. This template would typically be in the theme's \"Assets/Lava\" folder.", 0, @"{% include '~~/Assets/Lava/PageNav.lava' %}", "1322186A-862A-4CF1-B349-28ECB67229BA" );

            RockMigrationHelper.AddBlockTypeAttribute( "CACB9D1A-A820-4587-986A-D66A69EE9948", "BD53F9C9-EBA9-4D3F-82EA-DE5DD34A8108", "Root Page", "RootPage", "", "The root page to use for the page collection. Defaults to the current page instance if not set.", 0, @"", "41F1C42E-2395-4063-BD4F-031DF8D5B231" );

            RockMigrationHelper.AddBlockTypeAttribute( "CACB9D1A-A820-4587-986A-D66A69EE9948", "9C204CD0-1233-41C5-818A-C5DA439445AA", "Number of Levels", "NumberofLevels", "", "Number of parent-child page levels to display. Default 3.", 0, @"3", "6C952052-BC79-41BA-8B88-AB8EA3E99648" );
            ...
            RockMigrationHelper.AddBlockTypeAttribute( "CACB9D1A-A820-4587-986A-D66A69EE9948", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "Enable Debug", "EnableDebug", "", "Flag indicating that the control should output the page data that will be passed to Liquid for parsing.", 0, @"False", "2EF904CD-976E-4489-8C18-9BA43885ACD9" );
            ...
            RockMigrationHelper.AddBlockTypeAttribute( "51C366D6-EBD8-4202-BA5A-B845A7903ADC", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "Rss Autodiscover", "RssAutodiscover", "", "Determines if a RSS autodiscover link should be added to the page head.", 0, @"False", "80D0F9DD-7780-46A8-97F4-8D8A97359BEC" );

            RockMigrationHelper.AddBlockTypeAttribute( "51C366D6-EBD8-4202-BA5A-B845A7903ADC", "A75DFC58-7A1B-4799-BF31-451B2BBE38FF", "Filter Id", "FilterId", "", "The data filter that is used to filter items", 0, @"0", "210745A8-8537-41CA-BC4E-AB02E29EE0EA" );
            ...
            RockMigrationHelper.AddBlockTypeAttribute( "218B057F-B214-4317-8E84-7A95CF88067E", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "Hide the 'Active' Group checkbox", "HideActiveGroupCheckbox", "", "Set this to true to hide the checkbox for 'Active' for the group.", 5, @"False", "703D766A-F1BC-46FC-8176-7B42E4E41C48" );

            RockMigrationHelper.AddBlockTypeAttribute( "218B057F-B214-4317-8E84-7A95CF88067E", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "Hide Inactive Group Member Status", "HideInactiveGroupMemberStatus", "", "Set this to true to hide the radiobox for the 'Inactive' group member status.", 6, @"False", "F2F93D98-2F53-44AB-8B1E-284F0A306325" );
            ...
            RockMigrationHelper.AddBlockTypeAttribute( "218B057F-B214-4317-8E84-7A95CF88067E", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "Hide Group Description Edit", "HideGroupDescriptionEdit", "", "Set this to true to hide the edit box for group 'Description'.", 7, @"False", "E23ABB40-1D0D-43ED-A6D1-554E27D0F121" );

            RockMigrationHelper.AddBlockTypeAttribute( "218B057F-B214-4317-8E84-7A95CF88067E", "1D0D3794-C210-48A8-8C68-3FBEC08A6BA5", "Lava Template", "LavaTemplate", "", "The lava template to use to format the group details.", 8, @"{% include '~~/Assets/Lava/GroupDetail.lava' %}", "AEB81535-5E99-4AAB-9379-25C0C68111EC" );

            RockMigrationHelper.AddBlockTypeAttribute( "218B057F-B214-4317-8E84-7A95CF88067E", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "Enable Location Edit", "EnableLocationEdit", "", "Enables changing locations when editing a group.", 9, @"False", "7B080222-D905-4A4A-A1F7-8175D511F6E5" );

            RockMigrationHelper.AddBlockTypeAttribute( "218B057F-B214-4317-8E84-7A95CF88067E", "1EDAFDED-DFE6-4334-B019-6EECBA89E05A", "Enable Debug", "EnableDebug", "", "Shows the fields available to merge in lava.", 10, @"False", "E8BD8616-33CE-4017-B4BA-E04F0FDE231A" );

            RockMigrationHelper.AddBlockTypeAttribute( "218B057F-B214-4317-8E84-7A95CF88067E", "1D0D3794-C210-48A8-8C68-3FBEC08A6BA5", "Edit Group Pre-HTML", "EditGroupPre-HTML", "", "HTML to display before the edit group panel.", 11, @"", "29BCAE3E-7C98-4765-8804-AE6F7D326A18" );

            RockMigrationHelper.AddBlockTypeAttribute( "218B057F-B214-4317-8E84-7A95CF88067E", "1D0D3794-C210-48A8-8C68-3FBEC08A6BA5", "Edit Group Post-HTML", "EditGroupPost-HTML", "", "HTML to display after the edit group panel.", 12, @"", "B8273C24-A51C-4FCD-A29C-302133F7D236" );

            RockMigrationHelper.AddBlockTypeAttribute( "218B057F-B214-4317-8E84-7A95CF88067E", "1D0D3794-C210-48A8-8C68-3FBEC08A6BA5", "Edit Group Member Pre-HTML", "EditGroupMemberPre-HTML", "", "HTML to display before the edit group member panel.", 13, @"", "0162D261-2E91-4855-8FE4-572F6F7BBDDB" );

            RockMigrationHelper.AddBlockTypeAttribute( "218B057F-B214-4317-8E84-7A95CF88067E", "1D0D3794-C210-48A8-8C68-3FBEC08A6BA5", "Edit Group Member Post-HTML", "EditGroupMemberPost-HTML", "", "HTML to display after the edit group member panel.", 14, @"", "0DADE5FA-9FD2-4C95-B30C-4DE4A1FB66B5" );
...
{% endif %}" ); // Template
        ...
        public override void Down()
        {
            ...
            RockMigrationHelper.DeleteBlockType( "2AD8831E-8926-43A4-8CA1-095A60E0B2A2" );
            RockMigrationHelper.DeleteBlockType( "51C366D6-EBD8-4202-BA5A-B845A7903ADC" );
            RockMigrationHelper.DeleteBlockType( "AF0E5AE5-593C-4B18-B559-88BEF743D3E7" );
            RockMigrationHelper.DeleteBlockType( "18555BDC-87C1-4AD2-B22F-64936289A0D7" );
            RockMigrationHelper.DeleteBlockType( "1B172C33-8672-4C98-A995-8E123FF316BD" );
            RockMigrationHelper.DeleteBlockType( "218B057F-B214-4317-8E84-7A95CF88067E" );
