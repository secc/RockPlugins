...
namespace org.secc.Migrations
{
    ...
    class Purchasing_PageData :Migration 
    {
        public override void Up()
        {
            ...
            RockMigrationHelper.UpdateBlockType( "Capital Request List", "Lists all capital requests.", "~/Plugins/org_secc/Purchasing/CapitalRequestList.ascx", "SECC > Purchasing", "841A7C58-7902-4EA3-A2BE-668ACE74B491" );
            RockMigrationHelper.UpdateBlockType( "Requisition List", "Lists all requisitions.", "~/Plugins/org_secc/Purchasing/RequisitionList.ascx", "SECC > Purchasing", "FF7FBAAC-3203-4ADB-B084-C312885F4D39" );
            RockMigrationHelper.UpdateBlockType( "Vendor List", "List all vendors in the SECC Purchasing system.", "~/Plugins/org_secc/Purchasing/VendorList.ascx", "SECC > Purchasing", "FE8ED74E-F413-49D1-9A53-7CAB4A49A0ED" );
            RockMigrationHelper.UpdateBlockType( "Payment Method List", "List all payment methods in the SECC Purchasing system.", "~/Plugins/org_secc/Purchasing/PaymentMethodList.ascx", "SECC > Purchasing", "74D9FA79-09E8-4E2F-982F-99B6B78481C9" );
            RockMigrationHelper.UpdateBlockType( "Purchase Order List", "Lists/filters all Purchase Orders.", "~/Plugins/org_secc/Purchasing/POList.ascx", "SECC > Purchasing", "4A706E99-57E5-40D3-A537-9DB86297B819" );
