...
namespace org.secc.PastoralCare.Migrations
{
    ...
    class Pastoral_DefinedTypes : Migration
    {
        public override void Up()
        {
            ...
            RockMigrationHelper.AddDefinedType( "Global", "Nursing Homes", "Nursing Home List", "89C2E347-BDEF-4BF2-8A25-9D4EE2E9B405", @"" );
            RockMigrationHelper.AddDefinedTypeAttribute( "89C2E347-BDEF-4BF2-8A25-9D4EE2E9B405", "9C204CD0-1233-41C5-818A-C5DA439445AA", "City", "Qualifier2", "", 0, "", "CEDC60C1-0F9E-4FE2-BE62-41716813C969" );
            RockMigrationHelper.AddDefinedTypeAttribute( "89C2E347-BDEF-4BF2-8A25-9D4EE2E9B405", "9C204CD0-1233-41C5-818A-C5DA439445AA", "Notes", "Qualifier8", "", 0, "", "C47A879E-F737-4156-A1FF-B7C465FDB9BD" );
            RockMigrationHelper.AddDefinedTypeAttribute( "89C2E347-BDEF-4BF2-8A25-9D4EE2E9B405", "9C204CD0-1233-41C5-818A-C5DA439445AA", "Phone", "Qualifier5", "", 0, "", "A4E41679-2CE6-479F-84D4-6821B25E3649" );
            RockMigrationHelper.AddDefinedTypeAttribute( "89C2E347-BDEF-4BF2-8A25-9D4EE2E9B405", "9C204CD0-1233-41C5-818A-C5DA439445AA", "Pastoral Minister", "Qualifier6", "", 0, "", "D97EC9DE-5D6A-42FD-B4CE-0516FD5455F7" );
            RockMigrationHelper.AddDefinedTypeAttribute( "89C2E347-BDEF-4BF2-8A25-9D4EE2E9B405", "9C204CD0-1233-41C5-818A-C5DA439445AA", "State", "Qualifier3", "", 0, "", "239E507C-7C1B-4B4D-84D4-33C368843F05" );
            RockMigrationHelper.AddDefinedTypeAttribute( "89C2E347-BDEF-4BF2-8A25-9D4EE2E9B405", "9C204CD0-1233-41C5-818A-C5DA439445AA", "Street Address", "Qualifier1", "", 0, "", "73AC0DCE-CE90-4835-AAE7-E98B08F52E9D" );
            RockMigrationHelper.AddDefinedTypeAttribute( "89C2E347-BDEF-4BF2-8A25-9D4EE2E9B405", "9C204CD0-1233-41C5-818A-C5DA439445AA", "Zip", "Qualifier4", "", 0, "", "46A83E00-D530-48AD-B935-52C015DCA902" );
            RockMigrationHelper.AddDefinedValue( "89C2E347-BDEF-4BF2-8A25-9D4EE2E9B405", "Sample Nursing Home", "", "0997ACB6-A4B4-4766-B573-3C44D14DF343", false );
        ...
        public override void Down()
        {
            ...
            RockMigrationHelper.DeleteDefinedType( "89C2E347-BDEF-4BF2-8A25-9D4EE2E9B405" );
        }
    }
}
