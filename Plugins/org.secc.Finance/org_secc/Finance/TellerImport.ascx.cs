...
namespace RockWeb.Plugins.org_secc.Finance
{
    ...
    [EncryptedTextField(
           ...
           description: "This is key value for the  Rijndael algorithm",
           required: true,
           defaultValue: "",
           order: 2,
           key: "SecretKeyValue",
           isPassword: true )]
    [EncryptedTextField(
           name: "Initialization Vector Value",
           description: "This is the Initialization Vector Value for the  Rijndael algorithm",
           required: true,
           defaultValue: "",
           order: 3,
    ...
    public partial class TellerImport : Rock.Web.UI.RockBlock
    {
        ...
        {
            int i;
            string str = Encryption.DecryptString( GetAttributeValue( "SecretKeyValue" ) );
            string str1 = Encryption.DecryptString( GetAttributeValue( "InitializationVectorValue" ) );
