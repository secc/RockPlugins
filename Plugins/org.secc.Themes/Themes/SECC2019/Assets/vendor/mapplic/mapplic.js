...
;(function($) {
	...
	var Mapplic = function(element) {
			...
			this.addCategories = function(categories) {
				...
				if (categories) {
					$.each(categories, function(index, category) {
						...
						var link = $('<a></a>').attr('href', '#').attr('title', category.title).text(category.title).prependTo(item);
		...
		function Fullscreen() {
			...
			this.init = function() {
				// Fullscreen Button
				$('<a><i class="fa fa-arrows-alt" aria-hidden="true"></i></a>').attr('href', '#').attr('href', '#').addClass('mapplic-fullscreen-button').click(function(e) {
					e.preventDefault();
