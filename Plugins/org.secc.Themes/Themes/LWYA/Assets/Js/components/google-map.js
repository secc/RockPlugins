...
jQuery(document).ready(function($){
  ...
  var marker_url = ( is_internetExplorer11 ) ? '/Themes/LWYA/Assets/img/widgets/gmap/cd-icon-location.png' : '/Themes/LWYA/Assets/img/widgets/gmap/cd-icon-location.svg';
