...
jQuery(document).ready(function($){
  ...
  var marker_url = ( is_internetExplorer11 ) ? '/Themes/LWYA/Assets/img/widgets/gmap2/cd-icon-location.png' : '/Themes/LWYA/Assets/img/widgets/gmap2/cd-icon-location.svg';
