...
<asp:Content ID="ctMain" ContentPlaceHolderID="main" runat="server">
    ...
    <Rock:Lava ID="SecondaryImage" runat="server">
        ...
        {%- if secondaryImageId != '' -%}
        <div class="secondary-hero py-5" style="background: linear-gradient(90deg, var(--secondary-hero-overlay-color, rgba(0,0,0,0)), var(--secondary-hero-overlay-color, rgba(0,0,0,0))),url('/GetImage.ashx?Id={{ secondaryImageId }}&maxWidth=2500') center center; background-size: cover;">
        {%- else -%}
