...
module.exports = {
  setBuildBlock: function (block, options) {
    ...
    if (props.target && options && options.transformOutputPath) {
      props.target = options.transformOutputPath(props.target, props.type, props.attbs, props.alternateSearchPaths);
    }
