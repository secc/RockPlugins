<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AccountEdit.ascx.cs" Inherits="RockWeb.Plugins.org_secc.Security.AccountEdit" %>
    ...
    <ContentTemplate>
        ...
        <div class="row">
            ...
            <div class="col-md-3 hidden">
                <Rock:ImageEditor ID="imgPhoto" runat="server" Label="Photo" BinaryFileTypeGuid="03BD8476-8A9F-4078-B628-5B538F967AFC" Visible="false" />
            </div>
