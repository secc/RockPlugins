...
<asp:UpdatePanel runat="server">
    <ContentTemplate>
        <Rock:RegistrationTemplatePicker runat="server" ID="btnLoad" OnClick="btnLoad_SQL" Label="Registration Template" Help="Choose a registration template to sync photos"/>
