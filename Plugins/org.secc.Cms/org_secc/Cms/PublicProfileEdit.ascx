<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PublicProfileEdit.ascx.cs" Inherits="RockWeb.Plugins.org_secc.Cms.PublicProfileEdit" %>
        ...
        <asp:Panel ID="pnlView" runat="server">
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <br />
                    <asp:LinkButton ID="lbEditPerson" runat="server" CssClass="btn btn-primary btn-xs pull-right" OnClick="lbEditPerson_Click" CausesValidation="false"> Update</asp:LinkButton>
                </div>
            </div>
            <hr />
                ...
                <ItemTemplate>
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <asp:LinkButton ID="lbEditGroupMember" runat="server" CssClass="btn btn-primary btn-xs pull-right" CommandArgument='<%# Eval("PersonId") %>' CommandName="Update"> Update</asp:LinkButton>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <asp:Panel ID="pnlEdit" runat="server">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <Rock:DataTextBox ID="tbFirstName" runat="server" SourceTypeName="Rock.Model.Person, Rock" PropertyName="FirstName" Required="true" ReadOnly="true" />
