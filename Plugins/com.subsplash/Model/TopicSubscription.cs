...
{
    /// <summary>
    /// TopicSubscription is a representation of a subscription between a user&#x27;s PlatformEndpoint and a Topic.  In this case, a user&#x27;s PlatformEndpoint is supplied directly. 
    /// </summary>
    [DataContract]
        public partial class TopicSubscription :  IEquatable<TopicSubscription>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TopicSubscription" /> class.
        /// </summary>
        ...
        /// <param name="awsSnsSubscriptionArn">Topic Subscription Amazon Resource Name.</param>
        /// <param name="links">links.</param>
        /// <param name="embedded">embedded.</param>
        public TopicSubscription(Guid? id = default(Guid?), string appKey = default(string), DateTime? createdAt = default(DateTime?), DateTime? updatedAt = default(DateTime?), DateTime? deletedAt = default(DateTime?), string awsSnsSubscriptionArn = default(string), SelfLink links = default(SelfLink), TopicSubscriptionEmbedded embedded = default(TopicSubscriptionEmbedded))
        {
            this.Id = id;
            this.AppKey = appKey;
        ...
        /// <summary>
        /// Topic Subscription Amazon Resource Name
        /// </summary>
        /// <value>Topic Subscription Amazon Resource Name</value>
        ...
        public TopicSubscriptionEmbedded Embedded { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TopicSubscription {\n");
        ...
        {
            return this.Equals(input as TopicSubscription);
        }

        /// <summary>
        /// Returns true if TopicSubscription instances are equal
        /// </summary>
        /// <param name="input">Instance of TopicSubscription to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TopicSubscription input)
        {
            if (input == null)
                return false;
