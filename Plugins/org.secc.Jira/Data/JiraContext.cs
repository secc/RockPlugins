...
{
    public class JiraContext : Rock.Data.DbContext
    {
        #region Models
        public DbSet<JiraTopic> JiraTopics { get; set; }
        ...
        protected override void OnModelCreating( DbModelBuilder modelBuilder )
        {
            ...
            Database.SetInitializer<JiraContext>( new NullDatabaseInitializer<JiraContext>() );
