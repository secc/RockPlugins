...
namespace org.secc.Rise.Reporting.DataFilter
{
    ...
    /// 
    /// </summary>
    [Description( "Filter people who have not comlpeted a course." )]
    [Export( typeof( DataFilterComponent ) )]
    [ExportMetadata( "ComponentName", "Incomplete Course" )]
    public class IncompleteCoursesFilter : DataFilterComponent
    {
        #region Properties
...
function() {{
    ...
    return 'Has not completed ' + courseName;
}}";
        }
        ...
        public override string FormatSelection( Type entityType, string selection )
        {
            ...
            string result = $"Has not completed {course.Name}";
            return result;
        }
