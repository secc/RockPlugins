...
namespace org.secc.Rise.Reporting.DataSelect
{
    ...
    /// 
    /// </summary>
    [Description( "Show if person has completed a course" )]
    [Export( typeof( DataSelectComponent ) )]
    [ExportMetadata( "ComponentName", "Show if person has completed course" )]
    public class HasCompletedCourse : DataSelectComponent
    {
        #region Properties
        ...
        public override System.Web.UI.Control[] CreateChildControls( System.Web.UI.Control parentControl )
        {
            ...
            return new Control[1] { ddlCourses };
        }
