...
{
    public class GroupManagerContext : Rock.Data.DbContext
    {
        #region Models
        public DbSet<PublishGroup> PublishGroups { get; set; }
        #endregion

        /// <summary>
        /// Initializes a new instance of the <see cref="GroupManagerContext"/> class.
        /// </summary>
        public GroupManagerContext()
            : base( "RockContext" )
        {
        ...
        protected override void OnModelCreating( DbModelBuilder modelBuilder )
        {
            ...
            Database.SetInitializer<GroupManagerContext>( new NullDatabaseInitializer<GroupManagerContext>() );
