...
xcopy /Y /R "bin\Debug\Microsoft.Owin.Security.Oauth*" "bin\$pluginName\content\bin"
xcopy /Y /R "bin\Debug\Microsoft.Owin.Security.Cookies*" "bin\$pluginName\content\bin"
