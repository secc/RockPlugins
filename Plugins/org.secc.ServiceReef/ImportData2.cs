                ...
                while (total > processed)
                {
                    ...
                    if (response.Data != null && response.Data.PageInfo != null)
                    {
                        ...
                        foreach (Contracts.Events.Result result in response.Data.Results)
                        {
                            ...
                            if (result.EventId > 0)
                            {
                                trip = trips.Where(t => t.Name == string.Format("{0} Mission Trips", result.StartDate.Year)).FirstOrDefault();
                            ...
                            if (trip == null)
                            {
                                ...
                                tripPG.Name = string.Format("{0} Mission Trips", result.StartDate.Year);
                            ...
                            Rock.Model.Attribute groupattribute = null;
                            ...
                            if (eventResult.Data != null && eventResult.Data.Categories.Count > 0)
                            {
                                ...
                                {
                                    groupattribute = groupattributes.Where(a => a.Name == categorysimple.Name).FirstOrDefault();
                                    ...
                                    if (option != null)
                                    {
                                        groupattributeValue.Value = option.Name;
                                    }
                                    dbContext.SaveChanges();
                                }
                            }
