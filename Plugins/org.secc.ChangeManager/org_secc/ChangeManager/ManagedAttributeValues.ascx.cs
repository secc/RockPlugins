...
{
    /// <summary>
    /// User control for editing the value(s) of a set of attributes for person using Change Manager
    /// </summary>
    [DisplayName( "Managed Attribute Values" )]
    [Category( "SECC > CRM" )]
    [Description( "Allows for editing the value(s) of a set of attributes for person using Change Manager." )]
    ...
    public partial class ManagedAttributeValues : PersonBlock
    {
